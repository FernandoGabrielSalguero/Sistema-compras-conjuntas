                            ...
                            <div class="input-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <select id="categoria" name="categoria" required>
                                        ...
                                        <option value="Postes Metálicos y ancla">Postes Metálicos y ancla</option>
                                        ...
                                        <option value="Bioestimulantes Radioculares">Bioestimulantes Radioculares</option>
                                        <option value="Hormiguicidas">Hormiguicidas</option>
                                        <option value="Sistemicos Peronóspera">Sistemicos Peronóspera</option>
                                        <option value="Plantas Vitis Vinifera">Plantas Vitis Vinifera</option>
