...
<body style="padding: 2rem; background: #f9fafb;">
    ...
    <h2 style="margin-bottom: 1rem;">Cooperativa Editar Pedido #<?= $pedido_id ?></h2>
    ...
    <script>
        function eliminarFactura() {
            ...
            fetch('/controllers/coop_listadoPedidosController.php', {
                    method: 'POST',
                    headers: {
        ...
        function actualizarTotales() {
            ...
            document.querySelectorAll('#tablaProductos tbody tr').forEach(tr => {
                ...
                const precio = parseFloat(tr.children[4].textContent.replace('$', '').replace(/,/g, '')) || 0;
