                        ...
                        <div class="form-grid grid-2">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="usuario" name="prod_nombre" placeholder="¿Cuál es el nombre del productor que vas a asociar?" autocomplete="off" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group password-container">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="password" id="contrasena" name="prod_contra" placeholder="Asignale una contraseña a este nuevo productor" autocomplete="new-password" readonly>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-icon input-icon-cuit">
                                    ...
                                    <input type="text" id="cuit" name="cuit" inputmode="numeric" pattern="\d*" maxlength="11" placeholder="Coloca el CUIT sin guiones" oninput="this.value = this.value.replace(/\D/g, '')" readonly>
                                </div>
                            </div>
