<div style="padding:10px;border:1px solid rgba(0,0,0,.08);border-radius:8px;">
    <b>KPI Drones</b>
    <div id="sveKpiDronesStatus" style="margin-top:6px;font-size:14px;opacity:.9;">Chequeando conexion...</div>
</div>
...
<script>
    (() => {
        ...
        async function check() {
            ...
            try {
                const res = await fetch('../partials/sve_kpi/sve_kpi_dronesController.php', {
                    method: 'POST',
