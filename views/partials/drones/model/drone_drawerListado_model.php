<?php
// MODEL del drawer: detalle FULL + actualización
...
final class DroneDrawerListadoModel
{
    ...
    /** Actualiza solicitud + tablas relacionadas (migrado del modelo original) */
    ...
    private static function yn($v){ $v = strtolower((string)($v ?? 'no')); return $v === 'si' ? 'si' : 'no'; }
}
