<?php
// Modal del Registro Fitosanitario: vista FORMATEADA + pestaña JSON.
?>
    ...
    <div class="modal-content" style="max-width: 1024px;">
        ...
        <div id="fito-formato" style="background:#fff; border-radius:14px; padding:16px;">
            ...
            <div class="card" style="margin-top:12px; padding:12px; border:1px solid #e5e7eb; border-radius:12px;">
                ...
                <div id="fito-galeria" class="grid" style="display:grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap:8px;"></div>
...
(function(){
    ...
    function populateFormato(data){
        ...
        if(hasCond){ condBox.style.display='block'; }
        ...
        media.forEach(m=>{
            ...
            if(m.tipo === 'foto'){
                ...
                fig.style.margin='0';
                fig.innerHTML = `<img src="${esc(url)}" alt="Foto" style="width:100%; height:120px; object-fit:cover; border-radius:10px; border:1px solid #e5e7eb;">`;
        ...
        if(firmaPrestador) { firmaPrestadorEl.src = firmaPrestador; }
        if(firmaCliente)   { firmaClienteEl.src   = firmaCliente; }
    }
    ...
    // API global
    window.FitoJSONModal = { open, close: closeModal };
})();
</script>
