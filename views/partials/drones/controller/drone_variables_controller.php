...
try {
    ...
    if ($action === 'create' || $action === 'update') {
        ...
        if ($entity === 'pilotos') {
            out(['ok' => false, 'error' => 'Pilotos es solo lectura (se gestionan desde Usuarios)'], 405);
        }
    ...
    if ($action === 'delete') {
        ...
        if ($entity === 'pilotos')       out(['ok' => false, 'error' => 'Pilotos es solo lectura (no se puede eliminar desde aquí)'], 405);
